...
public class ScanResultAdapter extends BaseAdapter {
    ...
    public long getItemId(int position) {
        return arrayList.get(position).getDevice().getAddress().hashCode();
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        deviceDataView.setText("Data");
        lastSeenView.setText(getTimeSinceString(context, scanResult.getTimestampNanos()));
    ...
    private int getPosition(String address) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            if (arrayList.get(i).getDevice().getAddress().equals(address)) {
                position = i;
                break;
            }
        }
    ...
    public void add(ScanResult scanResult) {
        ...
        if (existingPosition >= 0) {
            ...
            arrayList.set(existingPosition, scanResult);
        } else {
